...
graphErrors = {"G_LOW_ENTRY_COUNT":("Output Node %s has lower Entry Count than maximum Entry ID (ID:%d)",
               ...
               "G_EFX_HIGH_ENTRY_COUNT":("EFX Output Node %s has higher Entry Count than EFX File has injection positions (%d)",
                                ["Multiple Posssible Solutions:",
                                 "-Add injection points by adding hollow TIML entries to the EFX on the relevant entries (See: 'Adding TIML Injection Points' on the documentation)",
